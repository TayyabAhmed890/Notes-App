...
const NoteCard = ({ note,setNotes }) => {
  ...
  const handleDelete = async (e,id) => {
    ...
    try {
     ...
     toast.success("Note Deleted Successfully!")
      ...
      toast.success("Failed to Deleted Note!")
  ...
  return (
    <Link to={`/note/${note._id}`} className='card bg-base-100 hover:shadow-lg transition-all duration-200 border-solid border-t-4 border-green-400'>
